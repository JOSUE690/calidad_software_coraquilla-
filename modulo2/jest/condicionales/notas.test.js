// matchers > numericos > notas.test.js
const { calcularPromedio, aplicarDescuento, notaMaxima, notaMinima } = require('./notas');

describe('Pruebas de Matchers Numéricos en Notas', () => {
    ...
    // toBeCloseTo - comparar decimales (0.1 + 0.2 != 0.3)
    test('promedio de [1, 2] es cercano a 1.5', () => {
        // Sin toBeCloseTo algunos decimales fallan por precisión
    ...
    test('promedio con decimales - toBeCloseTo evita error', () => {
